...
namespace NineLineNotation
{
    ...
    public class RibbonButton : RibbonItem, IContainsRibbonComponents
    {
        ...
        [DefaultValue(false)]
        [Description("Toggles the Checked property ofd")]
        public virtual bool setisClick
        {
            get
            {
                return isClick;
        ...
        public override void OnClick(EventArgs e)
        {
            ...
            {
          //    ((RibbonComboBox)this.ParentItem).TextBoxText = this.Text;//将box的内容填上text
            }
