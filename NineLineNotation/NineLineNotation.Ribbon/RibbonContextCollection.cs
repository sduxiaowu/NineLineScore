...
namespace NineLineNotation
{
        ...
        : List<RibbonContext>
    {
        ...
        public new void AddRange(System.Collections.Generic.IEnumerable<NineLineNotation.RibbonContext> items)
        {
        ...
        public new void Insert(int index, NineLineNotation.RibbonContext item)
        {
            item.SetOwner(Owner);
